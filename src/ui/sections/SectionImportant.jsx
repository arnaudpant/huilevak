    ...
    return (
        <section className="px-4 sm:px-8 py-6 sm:py-12 bg-fond">
            ...
            <div className="container mx-auto text-lg">
                ...
                <p className="py-2">
                    En aucun cas il ne peut faire l’objet d’une prescription, ni
                    engager la responsabilité de l’entreprise “HuilesVak”.
                </p>
                <p>
                    Si vous envisagez faire l’utilisation de ces produits dans
                    une démarche thérapeutique, nous vous recommandons vivement
                    de consulter un professionnel de santé. L’entreprise
                    «HuilesVak» ne peut pas être tenu pour responsable dans le
